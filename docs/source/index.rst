...
astronomical datasets on hexagonal grids. It is ideally suited for combining
a heterogeneous set of 2D maps and 3D spectral cubes observed at different
angular resolutions and pixel scales into a single, science-ready table for
sightline-by-sightline analysis.
...
.. important::
   ...
   This code is actively developed and the API may change between versions.
...
PHANGS collaboration. The routines have been updated, extended, and rewritten
in Python.
